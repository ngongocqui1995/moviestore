  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          store = Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["default"])(); // const carouselMainHome = fetchData.__get_Data_Carousel_Main_Home()
          ...
          //   topViewsCenima, mainRomance_1, mainRomance_2, mainRomance_3, mainRomance_4, mainRomance_5, mainRomance_6, mainRomance_7, mainRomance_8,
          //   mainRomance_9, mainRomance_10, mainComedy, newUpdateAnime, recommendAnime_1, recommendAnime_2, recommendAnime_3, recommendAnime_4, 
          ...
          //   store.dispatch(storeMainRomance_6(result[48]))
          //   store.dispatch(storeMainRomance_7(result[49]))
          //   store.dispatch(storeMainRomance_8(result[50]))
          //   store.dispatch(storeMainRomance_9(result[51]))
          //   store.dispatch(storeMainRomance_10(result[52]))
...
//# sourceMappingURL=index.js.a4b6838321bac47d0ca2.hot-update.js.map