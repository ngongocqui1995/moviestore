      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return Promise.all([carouselMainHome, featureMainHome, newUpdateMainHome, trendsMainHome, commonMovies_1, commonMovies_2, commonMovies_3, commonMovies_4, commonMovies_5, commonMovies_6, topWeek_1, topWeek_2, topWeek_3, topWeek_4, topWeek_5, topWeek_6, newDay_1, newDay_2, newDay_3, newDay_4, newDay_5, newDay_6, newDay_7, newDay_8, newDay_9, newDay_10]).then(function (result) {
            ...
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeFeatureMainHome"])(result[1]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewUpdateMainHome"])(result[2]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTrendsMainHome"])(result[3]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_1"])(result[4]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_2"])(result[5]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_3"])(result[6]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_4"])(result[7]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_5"])(result[8]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeCommonMovies_6"])(result[9]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_1"])(result[10]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_2"])(result[11]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_3"])(result[12]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_4"])(result[13]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_5"])(result[14]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeTopWeek_6"])(result[15]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_1"])(result[16]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_2"])(result[17]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_3"])(result[18]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_4"])(result[19]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_5"])(result[20]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_6"])(result[21]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_7"])(result[22]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_8"])(result[23]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_9"])(result[24]));
            store.dispatch(Object(_store_store__WEBPACK_IMPORTED_MODULE_15__["storeNewDay_10"])(result[25]));
          }).catch(function (err) {
            console.log(err);
          });
...
//# sourceMappingURL=Home.js.6a8bcca522a60b6f5e8e.hot-update.js.map