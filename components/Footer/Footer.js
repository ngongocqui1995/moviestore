        ...
        return (
            <footer className="site-footer" id="site-footer">
                ...
                <div className="container">
                    <div className="pt-e-40"></div>
                    <div className="row">
                        <div className="col-lg-4 col-xl-3 order-2 order-lg-1">
                            <div className="footer-widget-1">
                                <div className="footer-logo mb-2">
                                    <a className="brand d-flex align-items-center" href="home.html">
                                        ...
                                        <strong className="p-1 fs-8">Adonis</strong>
                                    </a>
                                </div>
                                <div className="widget">
                                    <h5 className="widget-title">Adonis Music, Radio Online Network</h5>
                                    ...
                                    <p className="copyright"> Copyright &copy; 2018 IconikTech. All rights reserved.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-8 col-xl-9 pl-e-lg-70 order-1">
                            <div className="row">

                                <div className="col-md-6 col-xl-2">
                                    <div className="footer-about">
                                        <div className="widget">
                                            <h5 className="widget-title">Adonis Music</h5>
                                ...
                                <div className="col-md-6 col-xl-4">
                                    <div className="widget">
                                        <h5 className="widget-title">Recent Albums</h5>
                                            ...
                                            <div className="img-box-horizontal music-img-box img-box-horizontal-style-2">
                                                ...
                                                <div className="hover-state d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div className="d-flex align-items-center">
                                                        <span className="adonis-icon color-active pointer mr-2 icon-2x"><svg xmlns="http://www.w3.org/2000/svg" version="1.1"><use xlinkHref="#icon-heart-blank" /></svg></span>
                                                        <span className="pointer dropdown-menu-toggle"><span className="icon-dot-nav-horizontal color-active"></span></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="img-box-horizontal music-img-box img-box-horizontal-style-2">
