...
export default class Tab_Menu_Cenima extends Component {
    render() {
        return (
                    ...
                    <div className="tabs tab-style-1 scroll-x">
                        <ul className="nav nav-border">
                            ...
                            <li className="menu-item active">
                                <a className="nav-link active" data-toggle="tab" href="/cenima">
                            ...
                            <li className="menu-item">
                                <a className="nav-link" data-toggle="tab" href="/romance">
