...
export default class Tab_Menu_Romance extends Component {
    render() {
        return (
            <div className="mb-e-30 mb-e-lg-50">
                <div className="mt-auto mb-3">
                    <div className="tabs tab-style-1 scroll-x">
                        <ul className="nav nav-border">
                            ...
                            <li className="menu-item">
                                <a className="nav-link" data-toggle="tab" href="/cenima">
                            ...
                            <li className="menu-item active">
                                <a className="nav-link active" data-toggle="tab" href="/romance">
                            ...
                            <li className="menu-item">
                                <a className="nav-link adonis-ajax-load" data-toggle="tab" href="/anime" >
                            ...
                            <li className="menu-item">
                                <a className="nav-link adonis-ajax-load" data-toggle="tab" href="/comedy">
                            ...
                            <li className="menu-item">
                                <a className="nav-link adonis-ajax-load" data-toggle="tab" href="/news"  >
