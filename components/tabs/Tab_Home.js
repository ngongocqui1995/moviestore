            ...
            <div className="tabs tab-style-1 scroll-x">
                <ul className="nav nav-border js-parent adonis-tabbed-nav moving-border">
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-news" data-content="http://iconiktech.com/adonis/demo-02/parts/browse/news.html">
                            <span className="adonis-icon pr-3 icon-4x">
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-new-music" data-content="parts/browse/new-music.html">
                            <span className="adonis-icon pr-3 icon-1x">
                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 12.29 16.21">
                                    ...
                                    <g data-name="Layer 2">
                                        <g id="new_music_icon" data-name="new music icon" className="cls-1">
                                            <g id="new_music_icon-2" data-name="new music icon">
                                                <path className="cls-2" d="M6.37,16.21l.12,0H6.37ZM6.58.08h0L6.37,0V0h0a.4.4,0,0,0-.4.4V10.5a3.4,3.4,0,1,0,.81,2.91.39.39,0,0,0,.07-.21V1.12a7.6,7.6,0,0,1,3.26,2.74.39.39,0,0,0-.17,0,.4.4,0,1,0,.55.15l0,0,.63-.31A8.51,8.51,0,0,0,6.58.08ZM3.37,15.36a2.56,2.56,0,1,1,2.56-2.56A2.56,2.56,0,0,1,3.37,15.36ZM11.31,4.14V7c0,.23.08.46.09.7h.89A8.41,8.41,0,0,0,11.31,4.14Z"></path>
                                            </g>
                                        </g>
                                    </g>
                                </svg>
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-playlists" data-content="parts/browse/playlists.html">
                            <span className="adonis-icon pr-3 icon-3x">
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-charts" data-content="parts/browse/charts.html">
                            <span className="adonis-icon pr-3 icon-3x">
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-genres" data-content="parts/browse/genres.html">
                            <span className="adonis-icon pr-3 icon-3x">
                    ...
                    <li className="menu-item">
                        <a className="nav-link adonis-ajax-load m-item m-item-block" href="#" data-target="#browse-videos" data-content="parts/browse/videos.html">
                            <span className="adonis-icon pr-3 icon-3x">
