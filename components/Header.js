...
const Header = () => (
    <header id="site-header" className="site-header mb-1">
        <div className="container header-inner">
            <div className="row">
                <div className="col-auto col-md-5 col-xl-5 d-flex align-items-center">
                    <div className="d-block d-lg-none">
                        <a href="#" className="navbar-toggler toggle-off-canvas-main-menu" data-target="#primary-menu-offcanvas">
                        ...
                        <div className="collapse navbar-collapse">
                            <ul className="navbar-nav mr-auto">
                                <li className="nav-item dropdown active" data-hover="dropdown">
                                    <a className="menu-item dropdown-toggle" href="home.html" aria-expanded="false">Home</a>
                                    <div className="dropdown-menu dropdown-mega-menu dropdown-bg">
                                        <span className="triangle adonis-icon icon-sm">
                                        ...
                                        <div className="col">
                                            ...
                                            <ul className="list-unstyled">
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">classNameical</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Pop</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Under Ground</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Metal</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Rock</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Jazz</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">Country</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">World</a>
                                                </li>
                                                <li className="menu-item">
                                                    <a href="genre-classNameical.html">All genres</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div className="col">
                                ...
                                <li className="menu-item">
                                    ...
                                    <div className="dropdown-menu dropdown-md">
                                        <span className="triangle adonis-icon">
                ...
                <div className="col-auto col-md-2 col-xl-2 d-flex align-items-center justify-content-center p-0">
                    <div className="brand">
                        <a className="brand d-flex align-items-center" href="home.html">
                                ...
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 32">
                                    <defs>
                                        <linearGradient id="Gradient" x1="0" y1="0" x2="100%" y2="0">
                                            <stop offset="0%" stopColor="#b08cf9" />
                                            <stop offset="100%" stopColor="#91a5f4" />
                                        </linearGradient>
                                    </defs>
                            ...
                            <strong className="p-1 fs-6 fs-lg-8">Anime</strong>
                        </a>
                    </div>
                </div>
                <div className="col-auto col-xl-5 d-flex justify-content-end justify-content-lg-end align-items-center navbar-secondary ml-auto">
                    <div>
                        <a id="btn-search-4" className="nav-link" href="#">
                    ...
                    <div className="nav-item d-none d-md-block">
                        <a className="nav-link notification-toggle has-notification" href="#" id="dropdownUsernotifications" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <span className="adonis-icon notification icon-4x">
                        ...
                        <div className="dropdown-menu dropdown-menu-right p-4 notifications clearfix" role="menu">
                            ...
                            <div className="media notification">
                                ...
                                <div className="notification-desc">
                                    <p>New Album from
                                        <a href="#" className="active-color">Brenda Lee</a>
                                    </p>
                                    <p>
                                        <a href="#">Catch Me Outside</a>
                                    </p>
                                    <em className="inactive-color">2 Hours ago</em>
                                    <span className="adonis-icon close-notification icon-1x">
                            ...
                            <div className="media notification">
                                ...
                                <div className="notification-desc">
                                    <p>New Album from
                                        <a href="#" className="active-color">Adm Smith</a>
                                    </p>
                                    <p>
                                        <a href="#">Catch Me Outside</a>
                                    </p>
                    ...
                    <div className="nav-item position-relative">
                        <a className="nav-link dropdown-toggle w-nowrap pr-0" href="#" id="dropdownUserSettings" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
                            <div className="flex-row d-inline-flex">
                                <div className="user">
                                    <img className="rounded-circle" src="/static/assets/images/user-thumb-1.jpg" alt=""/>
                                </div>
                        ...
                        <div className="dropdown-menu dropdown-menu-right user-settings-dropdown clearfix" aria-labelledby="dropdownUserSettings">
                            ...
                            <div className="settings-bottom">
                                ...
                                <ul className="user-settings-menu list-unstyled">
                                    <li>
                                        <a href="#" className="inactive-color">
                                            <span className="adonis-icon notification mr-3 icon-3x">
                                    ...
                                    <li>
                                        <a href="#" className="inactive-color">
                                            <span className="adonis-icon mr-3 icon-3x">
                                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                    ...
                                    <li>
                                        <a href="#" className="inactive-color">
                                            <span className="adonis-icon mr-3 icon-2x">
                                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                    ...
                                    <li>
                                        <a href="#" className="inactive-color">
                                            <span className="adonis-icon mr-3 icon-4x">
