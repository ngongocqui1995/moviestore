...
class NewUpdate_Anime extends Component {
                                    ...
                                    !data || data.length === 0 ? "" : data.map((prop, key) => (
                                        <div key={key} className="item">
                                            <div className="music-img-box">
                                                ...
                                                <h6 className="title"><a href={`/detail/${prop.key}`}>{data[0].title}</a></h6>
...
export default connect(mapStateToProps) (NewUpdate_Anime)