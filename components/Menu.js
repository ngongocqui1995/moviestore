        ...
        <div className="side-nav-container d-flex flex-column align-items-center ml-auto mr-auto position-relative">
            <ul className="side-nav adonis-animate" data-animation="menuTwo" id="site-side-nav" data-level="1" data-animation-item="> li > a">
                ...
                <li className="nav-item has-dropdown">
                    <a className="nav-link" href="#" data-level="2">Shop
                        <span className="adonis-icon icon-sm">
                    ...
                    <ul className="sub-level">
                        <li>
                            <a href="#" className="go-back" data-level="1">Back</a>
                        </li>
                        <li className="">
                ...
                <li className="nav-item has-dropdown">
                    <a className="nav-link" href="#" data-level="2">Browse
                        <span className="adonis-icon icon-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10">
                ...
                <li className="nav-item has-dropdown">
                    <a className="nav-link" href="#" data-level="2">Genres
                        <span className="adonis-icon icon-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10">
                ...
                <li className="nav-item has-dropdown">
                    <a className="nav-link" href="#" data-level="2">Charts
                        <span className="adonis-highlight-active fs-1">hot</span>
                        <span className="adonis-icon icon-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10">
                ...
                <li className="nav-item has-dropdown">
                    <a className="nav-link" href="#" data-level="2">More
                        <span className="adonis-icon icon-sm">
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="10">
